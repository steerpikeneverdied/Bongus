// Barrel: view-read tuning singletons — single source is the config registry via content C.
import { C } from '../game/content.ts';
export const BOARD = C.BOARD;
export const HAPTICS = C.HAPTICS;
