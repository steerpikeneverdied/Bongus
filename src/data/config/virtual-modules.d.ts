...
// @fortis/bishop-config-registry/vite (see vite.config.ts). Statically imported once by the
...
// `virtual:asset-registry` — the resolved asset database emitted by @fortis/bishop-asset-registry/vite.
