...
export const STRINGS = {
  ...
  combat: {
    ...
    bossSpecial: 'BOSS SPECIAL',   // ⚠ flanks added by the renderer via <Icon>/registry (Autobattler)
    critical: 'CRITICAL!',
    ...
    bossAhead: 'BOSS AHEAD',   // ⚠ / ⚔ flanks added by intro-director via the registry (art or emoji fallback)
    bossReveal: 'BOSS',
    unknownName: '? ? ?',
    threat: 'THREAT',
