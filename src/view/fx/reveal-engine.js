...
import { resolve } from '../assets.js';   // reward emoji fallback sourced from the registry
...
export function playChestReveal(
  containerEl,
  { rarity = 'rare', rewardAsset = null, rewardEmoji = resolve('ui.reward').emoji, rarityColor = null, focal = null, flyTo = null } = {},
  onDone,
) {
