        ...
        {slots.map((o) => {
          ...
          return (
            ...
            >
              ...
              <span className="otab">{special ? <span className="otab-s">S</span> : potion ? <Icon id="potion" className="otab-potion" /> : <Art a={resolve(`ui.chest.${o.rarity}`)} className="otab-art" />}</span>
              <div className="reqs">
