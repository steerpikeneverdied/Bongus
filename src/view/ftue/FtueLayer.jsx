...
// Reads {state, actions}, records completed beats, and drives the guided-tutorial affordances a beat can
// declare — all optional, all inline-styled, all detach cleanly with the layer. The FTUE NEVER
// force-navigates the screen — a beat spotlights the nav button and the PLAYER taps it (no jarring yanks):
//   • pause   — freezes the sim while the beat is on screen (via flags.ftuePaused; honoured by the
//               controller battle tick). The Alchemist-explain beat uses it.
