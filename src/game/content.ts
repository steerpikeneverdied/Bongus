...
export function createContent(bundle: GameConfigBundle) {
  ...
  const FTUE = b.ftue ? {
    ...
    startingOrderSlots: b.ftue.startingOrderSlots as number,
  ...
  return {
    ...
    CRYSTAL: b.crystalDrop, UNIQUE_DROP: b.uniqueDrop, TIER_PRESENTATION: b.tierPresentation, VFX: b.vfx, HAPTICS: b.haptics, RUNTIME: b.runtime, REVEAL: b.reveal, ANIM: b.anim, MINIGAME: b.minigame, SHOOTER: b.shooter, FTUE, DEBUG: b.debug,
