/**
 * assets registry — the format-agnostic asset database. Engine = @fortis/bishop-asset-registry over the
 * assets/ tree. Format schemas + extractors come from @fortis/bishop-asset-types-2d (side-effect imports).
...
import { formatFields } from '@fortis/bishop-config-registry';
import { getAssetSchema, listAssetTypes, validateDeclaration } from '@fortis/bishop-asset-registry';
import { scanAssetsDir, validateAssetsDir } from '@fortis/bishop-asset-registry/node';
import '@fortis/bishop-asset-types-2d';        // register runtime extractors
import '@fortis/bishop-asset-types-2d/schema'; // register authoring schemas
