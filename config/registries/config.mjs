/**
 * config registry — the gameplay LOGICAL config. Engine = @fortis/bishop-config-registry over the
...
} from '@fortis/bishop-config-registry';
import { scanConfigDir, createEntity, writeEntity } from '@fortis/bishop-config-registry/node';
