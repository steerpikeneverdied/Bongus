...
function help() {
  ...
  console.log('  config   gameplay logical config   src/data/config/game/**        (@fortis/bishop-config-registry)');
  console.log('  visual   per-entity VSM config      src/data/visual-config/**       (src/view/combat/vsm/schema.ts)');
  console.log('  assets   asset database             assets/**/assets.json          (@fortis/bishop-asset-registry)');
