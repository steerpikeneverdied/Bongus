...
The capture inbox is **`.cache/markdown/`** (the Marksman dev tool writes here; see the
`@fortis/bishop-marksman` package README). Two kinds of capture land there, both processed by this skill:
